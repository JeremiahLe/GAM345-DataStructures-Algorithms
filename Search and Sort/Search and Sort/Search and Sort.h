...
namespace GAM345Namespace {
	...
	public: 
		...
		void merge(int* leftArray, int leftSize, int* rightArray, int rightSize) {
			...
			int* answer = new int[leftSize + rightSize]; // 3 + 3 = 6
			...
			while (leftIndex < leftSize && rightIndex < rightSize) {  // while 0 < 3 && 0 < 3
		...
		*/
		...
		void MergeSort(int *aArray, int aSize) {
			...
			MergeSort(aArray, 0, aSize - 1); // call helper function 
